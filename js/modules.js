  ...
  // ============================================================
  {
    ...
    sections: [
      ...
      // ========================================
      {
        ...
        content: `
          ...
          <h3>活用例：契約書レビューを3分で回す</h3>
          <div class="example-box">
            <strong>📌 手元のファイルを渡して結果を即受け取る流れ</strong><br><br>
            1. 先方からの契約書を作業用フォルダに置く（または Finder で選択してパスをコピー）<br>
            2. Claude Code に「この契約書をレビューして。リスクのある条項を一覧にして」<br>
            3. 修正提案を確認後「修正案を新ファイルとして保存して」<br>
            4. 出力ファイルを開いて内容を確認し、先方へ送信
          </div>

          <div class="warning-box">
            <p><strong>元データは作業コピー・出力は必ず人が確認</strong></p>
            <p>Claude Code はファイルを直接書き換えられます。<strong>元データのコピーを入れた作業用フォルダ</strong>で進め、特に数値・金額・固有名詞は元データと照合してから使ってください。契約書・顧客資料・機密資料は特に慎重に扱います。</p>
          </div>
        `
      },
    ...
    quiz: [
      ...
      },
      {
        ...
        options: [
          'すべての作業を Skill にすべきだ',
          '繰り返し発生し・手順が明確で・品質基準がある作業を型にし、発動・品質・効率で検証して育てる',
          'Skill は一度作ったら変更してはいけない',
          'Skill は Claude Code では使えない'
        ],
        correct: 1,
        explanation: 'Skills は「繰り返し × 手順が明確 × 品質基準あり」が揃う作業で効果的です。作って終わりにせず、発動・品質・効率の3点で確認しながら育てます。'
      },
      {
