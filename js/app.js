  ...
  function renderLanding(container) {
    container.innerHTML = `
      <div class="landing-page fade-in">
        ...
        <div class="landing-setup" id="landing-setup-btn">
    ...
    container.querySelector('#landing-setup-btn')?.addEventListener('click', () => {
      setMode('self-study');
      setTimeout(() => navigateTo('setup'), 50);
    });
  }
    ...
    if (slideIdx === 0) {
      slideContent = `
        <div class="slide-cover">
          ...
          <div class="slide-cover-objectives"><h3>この回で身につくこと</h3>
